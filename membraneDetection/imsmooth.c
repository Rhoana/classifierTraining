...
/*
 *This software program is Copyright © 2006 The Regents of the
 ...
 *implementation is original (in particular, it is not derived from
 *Lowe's implementation), the SIFT algorithm has been issued a
 *patent. Thus you should note that:
 *
